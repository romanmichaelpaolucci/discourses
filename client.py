...
class Discourses:
    ...
    def analyze(
        ...
        Args:
            ...
            era: Era to use for analysis (primitive, ramp, meme, present).
    ...
    def compare_eras(
        ...
        Args:
            ...
            eras: List of eras to compare (primitive, ramp, meme, present).
